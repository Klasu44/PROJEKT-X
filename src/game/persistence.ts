...
export type SaveGame={version:number;chapter:number;flags:string[];chapterLog:string[];seen:string[];eventLog:string[];state:StateSnapshot;politics:PoliticalState;savedAt:string};
